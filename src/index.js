...
var index = (function () {
    ...
    return {
        main: (sdf_vertex, sdf_fragment) => {
            ...
            var [sdfs, alphaSDFImageData] = updateSDF(canvas2, ctx2);
            ...
            function _frame(time) {
                ...
                gl.uniform2f(shader.u_texsize, canvas2.width, canvas2.height);
